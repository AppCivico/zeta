use utf8;
package PI::Schema::Result::UserRole;
...
Related object: L<PI::Schema::Result::Role>

=cut

__PACKAGE__->belongs_to(
  "role",
  "PI::Schema::Result::Role",
  { id => "role_id" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:UcFEjYAPgmM9euP4uRwp1g
